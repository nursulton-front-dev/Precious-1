...
export const CATEGORIES: Category[] = [
  { id: 'lockstitch', icon: 'catLockstitch', nameKey: 'cat_lockstitch_name', countKey: 'cat_lockstitch_count' },
  { id: 'overlock', icon: 'catOverlock', nameKey: 'cat_overlock_name', countKey: 'cat_overlock_count' },
